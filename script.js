...
function selecionarOpcaoDeBebida(pratoEscolhido, elementoIcone, nomedeExibicao, precoPedido){
    console.log(pratoEscolhido, elementoIcone);
...
function selecionarOpcaoDeSobremesa(pratoEscolhido, elementoIcone, nomedeExibicao, precoPedido){
    console.log(pratoEscolhido, elementoIcone);
...
function enviarPedido(){
    ...
    let mensagemDoPedido = window.encodeURIComponent(`Olá, gostaria de fazer o pedido:\n\n- Prato: ${pratoSelecionado}\n- Bebida: ${bebidaSelecionada}\n- Sobremesa: ${sobremesaSelecionada}\n\nTotal: R$ ${valorTotal}\n\nNome: ${nomeUsuario}\nEndereço: ${enderecoUsuario}\nBairro: ${bairroUsuario} - São Paulo`);
